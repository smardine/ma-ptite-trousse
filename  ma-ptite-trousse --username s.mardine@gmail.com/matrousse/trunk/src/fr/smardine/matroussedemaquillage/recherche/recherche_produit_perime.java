 ...
 * @author smardine
 */
public class recherche_produit_perime extends SuperRechercheActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		EtFiltrage.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				filtreSelonSaisieEtBtActive(str, Cat.isChecked(),
	...
	protected void filtreSelonSaisieEtBtActive(String p_txtFiltrage,
			boolean p_isCatChecked, boolean p_isMarqueChecked,
		...
		switch (item.getItemId()) {
			...
			case 2001:
				...
				intentParametres.putExtra(
						ActivityParam.LaunchFromRechercheProduitPerime, true);
	...
	protected void gotoAffDetail(String IdProduit) {
		...
		intentDetail.putExtra(ActivityParam.LaunchFromRechercheProduitPerime,
				true);
	...
	// private void AfficheLeContenu(EnTypeFiltrage p_TypeRecherche,
	...
	// "Marque"));
	// MlListeProduits lstProduit = accesProduit.getListeProduitPerimeFiltree(
