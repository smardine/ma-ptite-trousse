...
import fr.smardine.matroussedemaquillage.remplir.formulaire_entree_page1;
...
public void onClick(View v) {
	...
	if (v==BtRemplir){
	    ...
	    if (nbDenregistrement>0){
	    	...
	    	intentFormPage1 = new Intent(Main.this, formulaire_entree_page1.class);
    		intentFormPage1.putExtra("calledFromMain",true);
    		//on demarre la nouvelle activité
    		startActivity(intentFormPage1);
    		finish();	
  ...
  /*  handler.removeCallbacks(updateTimeTask);
    handler.postDelayed(updateTimeTask, 1000);*/
       ...
       /*  AlphaAnimation anim11 = new AlphaAnimation(1, 0.2f);
         ...
         BtRemplir.startAnimation (anim11);*/
