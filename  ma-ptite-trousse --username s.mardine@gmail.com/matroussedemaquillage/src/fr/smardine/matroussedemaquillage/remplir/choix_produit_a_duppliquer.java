...
protected void gotoDuppliqueEtLanceFormPage3(String IdProduit) {
	...
	String[] Colonnes ={"nom_produit","nom_souscatergorie","nom_categorie","numero_Teinte",
			"Duree_Vie","Date_Peremption","DateAchat","nom_marque"}; 
	...
	//on rempli "trousse tempo" avec les valeurs de Categories et sous categorie afin que cescase soient cochée lors de l'affichage de la page1 du formulaire
	...
	//intentPage1Dupplique.putExtra("IDProduit", IdProduit);
	intentPage3Dupplique.putExtra("LaunchByDupplique", true);
	//intentPage1Dupplique.putExtra("AfficheProduitPerimé", IsAffichageProduitPerimé);
