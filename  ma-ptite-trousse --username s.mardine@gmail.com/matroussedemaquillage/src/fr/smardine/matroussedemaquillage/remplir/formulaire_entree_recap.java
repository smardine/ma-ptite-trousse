...
public class formulaire_entree_recap extends Activity implements OnClickListener {
		...
		adFiniOuPas.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				...
				if (Continue) {// on retourne a la 1° fenetre du formulaire
					Intent intent = new Intent(formulaire_entree_recap.this, formulaire_entree_page1bis.class);
	...
	private void updateDisplay() {
		...
		// CategorieRecap.setText(new StringBuilder().append("Categorie : ").append(Categorie_Cochée[1].toString().replace("[",
		// "").replace("]","")+" / ").append(Categorie_Cochée[0].toString().replace("[", "").replace("]","")));
