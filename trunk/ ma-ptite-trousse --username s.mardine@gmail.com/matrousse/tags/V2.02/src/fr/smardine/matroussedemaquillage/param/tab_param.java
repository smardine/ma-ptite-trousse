...
public class tab_param extends TabActivity implements OnTabChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isLaunchByNotePage1 = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromNotePage1, false);
		isLaunchByNoteSaisie = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromNoteSaisie, false);
		isLaunchByAfficheDetail = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromAfficheDetail, false);
		isLaunchByProduitPerime = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromRechercheProduitPerime, false);
		isLaunchByRecherche = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromRecherche, false);
		isLaunchByDupplique = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromDuppliquer, false);
		isLaunchByPage1 = getIntent().getBooleanExtra(
				ActivityParam.LaunchFromPage1, false);
		isLaunchBypagerecap = getIntent().getBooleanExtra(
