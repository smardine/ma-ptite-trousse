...
public class AccesTableProduitEnregistre {
	...
	private ArrayList<String> getTrousseComplete(int p_idProduits) {
		String requete = "Select " + EnStructProduitEnregistre.NOM_PRODUIT.getNomChamp() + " ,"
				...
				" Where " + EnStructProduitEnregistre.ID.getNomChamp() + "=" + p_idProduits;
	...
	public void CorrigeProduitsEnregistre(int p_idProduit) {
		...
		requeteFact.majTable(EnTable.PRODUIT_ENREGISTRE, modifiedValues, whereClause, whereArgs);
	 ...
	 */
	public void majDatepremeption(int p_idProduit, String p_datePeremption, long p_datePeremtInMilli, String p_perime,
			String p_presqueperime) {
		...
		requeteFact.majTable(EnTable.PRODUIT_ENREGISTRE, modifiedValues11, whereClause11, whereArgs11);
	}
}
