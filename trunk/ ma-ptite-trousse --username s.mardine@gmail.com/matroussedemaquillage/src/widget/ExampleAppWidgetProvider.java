/*
 * Copyright (C) 2008 The Android Open Source Project Licensed under the Apache License, Version 2.0 (the "License"); you may not use this
...
/**
 * A widget provider. We have a string that we pull from a preference in order to show the configuration settings and the current time when
 * the widget was updated. We also register a BroadcastReceiver for time-changed and timezone-changed broadcasts, and update then too.
 * <p>
