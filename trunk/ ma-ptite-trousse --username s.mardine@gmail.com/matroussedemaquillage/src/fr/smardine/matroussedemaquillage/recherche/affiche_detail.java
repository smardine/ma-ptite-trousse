	...
	private void majTableProduit() {
		...
		String[] Colonnes ={"nom_produit","nom_souscatergorie","nom_categorie","numero_Teinte",
	 	...
	 	// objBd.deleteTable("trousse_tempo","1",null);
	 	 //System.out.println("Nombre de champ modifie dans la table produit_Enregistre : "+nbdechamp+" sur l'id n° "+Id_Produits+"nom cat="+cat+"nom sous cat" + souscat);
	 	 objBd.close();
	}
		...
		// get the current date
         ...
         public void onClick(DialogInterface dialog, int whichButton) {  
           ...
           if (value.equals("")){
			...
			Date DatePeremption = getDateAfterDays(DatePeremtInMilli,nbJours);// on calcule la date de permetpion en fonction de la date d'achat+nb de jour donné par l'utilisateur
